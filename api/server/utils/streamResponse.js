...
const { parseConvo } = require('cbwchat-data-provider');
 ...
 * 서버-센트 이벤트(Server-Sent Events, SSE) 방식으로 클라이언트와 실시간 메시지를 주고받는 
 * 백엔드 유틸리티 함수들입니다. 특히 에러 메시지 처리, SSE 메시지 전송, 조건부 응답 처리,
 * DB에 메시지 저장 기능을 포함하고 있습니다
