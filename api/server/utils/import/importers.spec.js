...
const { EModelEndpoint, Constants, openAISettings } = require('cbwchat-data-provider');
...
/**
 * 다양한 포맷의 JSON 대화를 정확히 변환하고 저장하는지 확인
 * 메시지 트리 구조에서 부모-자식 관계가 올바르게 보존되는지 확인
 * 인용 링크를 포함한 어시스턴트 메시지 처리의 정확성 검증
 * 보안성 (ReDoS 방어 등) 및 예외 처리 검증
 */
